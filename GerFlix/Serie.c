...
/*void mostrarListaSeries(eSerie lista[], int tamanio)
{
    int retorno;
    int i;
    retorno=RetornarSerie(lista,tamanio,lista.idSerie);
    for(i=0;i<tamanio;i++)
    {
        printf("\nSerie: %s",lista[i].nombre);
    }

}*/

/*eSerie RetornarSerie(eSerie lista[], int tamanio, int idSerie)
{
    int i;
    int retorno=-1;
    for(i=0;i<tamanio;i++)
